...
import { forecastDays, forecastSummary } from '@/data/mock-forecast'
</script>
    ...
    <section class="grid gap-4 lg:grid-cols-[0.95fr_1.05fr]">
      <div class="panel-line rounded-panel bg-panel p-4 sm:p-5">
        ...
        <div class="mt-4 space-y-3">
          <div v-for="day in forecastDays.filter((item) => item.status !== 'normal')" :key="day.date" class="rounded-panel border border-line bg-background/70 p-3">
